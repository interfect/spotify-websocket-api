Spotify WebSocket API [![Build Status](https://travis-ci.org/interfect/spotify-websocket-api.png?branch=master)](https://travis-ci.org/interfect/spotify-websocket-api)
=====================
